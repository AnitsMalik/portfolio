...
function About() {
  return (
    <div id="about" className="container">
      <section>
        <div className="about_sac d-flex justify-content-center text-center">
        ...
        <div className="row align-items-center mb-5">
          <div className="col-md-8">
            <div className="hero-content-box">
              ...
              <div className="hero_box d-md-none text-center">
                <img src={anit} alt="logo" />
              </div>
              <div className="lead mt-3">
                Focused on meeting organizational goals within deadlines, while
                embracing additional responsibilities. Looking for UX/UI design
                opportunities where I can leverage my business insights and
          ...
          <div className="col-md-4 d-none d-md-block">
            <div className="tp-hero-text-box"></div>
            <div className="hero_image text-center float-end">
              <img src={anit} alt="anit" />
            </div>
          </div>
        </div>

        <CardGroup className="shadow mb-5">
          <Card>
            <Card.Body>
              <div className="abouttxt about_service">
                <h2>
                  <div className="cardiconabt">
                    <video
                      autoPlay
                      loop
                      muted
                ...
                <ul>
                  <li>
                    ...
                    <span className="card-text"> User Research & Wireframing</span>
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="card-text"> Accessibility & Usability</span>
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
